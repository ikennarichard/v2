      ...
      <div className="wrapper">
        ...
        <div className="details">
          ...
          <div className="text">
            ...
            <p>My journey into tech took an exciting turn when I joined the Microverse web development programme. Since then, I fell in love with React and Redux and have been using them eversince in web applications.</p>
